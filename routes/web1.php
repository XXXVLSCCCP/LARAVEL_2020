...
//        Route::get('/{category_id}', 'News1Controller@category')->where('category_id', '[0-9]+')->name('by_id');
//        Route::get('/{slug}', 'News1Controller@categorySlug')->name('by_slug');
//        Route::get('/', 'CategoriesController@index')->name('by_index');
//
//    });
//    Route::get('/', 'News1Controller@index')->name('index');
//    Route::get('/{id}', 'News1Controller@show')->name('show');
